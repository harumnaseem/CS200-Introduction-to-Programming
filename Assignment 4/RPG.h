...
struct Item{
	string itemName; // The name of item
 	int itemCateogry; // Items can be of two types. Weapons or HealthPortions. Weapons = 1. HealthPortions = 2.
...
struct Node{
	...
	int isVisited; // Could either be a 0 or a 1. This could be helpful when writing the search algorithm.
...
class GameManager{
	...
	public:
        Node* bossNode;
        Node* get_minionNodes(int index)
        {
            return minionNodes[index];
        }
